...
public class AndNand3Module extends Gate3Module {

	public AndNand3Module(int id, NumExpr nb, boolean inverting) {
		...
		bodyPath_0.quadTo(20.f, 15.f, 20.0f, 0.f);
