...
public class SHDL2VHDLConverter extends JFrame {
    ...
    void synthesize(File projectDir, File vhdlDir, ShdlDesign design, SHDLModule topModule, ArrayList moduleNames, SHDLBoard board) throws Exception {
        ...
        if (boardName.equals("Nexys-1000")) {
            ...
            if (new SHDLSignal("memadr<1>", 1, 1, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<1>\"  LOC = \"J1\" ;");
            if (new SHDLSignal("memadr<2>", 2, 2, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<2>\"  LOC = \"J2\" ;");
            if (new SHDLSignal("memadr<3>", 3, 3, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<3>\"  LOC = \"H4\" ;");
            if (new SHDLSignal("memadr<4>", 4, 4, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<4>\"  LOC = \"H1\" ;");
            if (new SHDLSignal("memadr<5>", 5, 5, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<5>\"  LOC = \"H2\" ;");
            if (new SHDLSignal("memadr<6>", 6, 6, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<6>\"  LOC = \"J5\" ;");
            if (new SHDLSignal("memadr<7>", 7, 7, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<7>\"  LOC = \"H3\" ;");
            if (new SHDLSignal("memadr<8>", 8, 8, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<8>\"  LOC = \"H6\" ;");
            if (new SHDLSignal("memadr<9>", 9, 9, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<9>\"  LOC = \"F1\" ;");
            if (new SHDLSignal("memadr<10>", 10, 10, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<10>\"  LOC = \"G3\" ;");
            if (new SHDLSignal("memadr<11>", 11, 11, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<11>\"  LOC = \"G6\" ;");
            if (new SHDLSignal("memadr<12>", 12, 12, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<12>\"  LOC = \"G5\" ;");
            if (new SHDLSignal("memadr<13>", 13, 13, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<13>\"  LOC = \"G4\" ;");
            if (new SHDLSignal("memadr<14>", 14, 14, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<14>\"  LOC = \"F2\" ;");
            if (new SHDLSignal("memadr<15>", 15, 15, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<15>\"  LOC = \"E1\" ;");
            if (new SHDLSignal("memadr<16>", 16, 16, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<16>\"  LOC = \"M5\" ;");
            if (new SHDLSignal("memadr<17>", 17, 17, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<17>\"  LOC = \"E2\" ;");
            if (new SHDLSignal("memadr<18>", 18, 18, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<18>\"  LOC = \"C2\" ;");
            if (new SHDLSignal("memadr<19>", 19, 19, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<19>\"  LOC = \"C1\" ;");
            if (new SHDLSignal("memadr<20>", 20, 20, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<20>\"  LOC = \"D2\" ;");
            if (new SHDLSignal("memadr<21>", 21, 21, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<21>\"  LOC = \"K3\" ;");
            if (new SHDLSignal("memadr<22>", 22, 22, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<22>\"  LOC = \"D1\" ;");
            if (new SHDLSignal("memadr<23>", 23, 23, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memadr<23>\"  LOC = \"K6\" ;");

            if (new SHDLSignal("memdb<0>", 0, 0, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<0>\"  LOC = \"L1\" ;");
            if (new SHDLSignal("memdb<1>", 1, 1, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<1>\"  LOC = \"L4\" ;");
            if (new SHDLSignal("memdb<2>", 2, 2, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<2>\"  LOC = \"L6\" ;");
            if (new SHDLSignal("memdb<3>", 3, 3, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<3>\"  LOC = \"M4\" ;");
            if (new SHDLSignal("memdb<4>", 4, 4, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<4>\"  LOC = \"N5\" ;");
            if (new SHDLSignal("memdb<5>", 5, 5, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<5>\"  LOC = \"P1\" ;");
            if (new SHDLSignal("memdb<6>", 6, 6, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<6>\"  LOC = \"P2\" ;");
            if (new SHDLSignal("memdb<7>", 7, 7, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<7>\"  LOC = \"R2\" ;");
            if (new SHDLSignal("memdb<8>", 8, 8, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<8>\"  LOC = \"L3\" ;");
            if (new SHDLSignal("memdb<9>", 9, 9, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<9>\"  LOC = \"L5\" ;");
            if (new SHDLSignal("memdb<10>", 10, 10, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<10>\"  LOC = \"M3\" ;");
            if (new SHDLSignal("memdb<11>", 11, 11, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<11>\"  LOC = \"M6\" ;");
            if (new SHDLSignal("memdb<12>", 12, 12, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<12>\"  LOC = \"L2\" ;");
            if (new SHDLSignal("memdb<13>", 13, 13, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<13>\"  LOC = \"N4\" ;");
            if (new SHDLSignal("memdb<14>", 14, 14, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<14>\"  LOC = \"R3\" ;");
            if (new SHDLSignal("memdb<15>", 15, 15, design.getTopModule()).containedIn(interfaceSignals)) pw.println("NET \"memdb<15>\"  LOC = \"T1\" ;");
        }
        pw.flush();
        pw.close();
