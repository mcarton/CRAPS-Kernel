...
public class SHDLPredefinedRamsAsynRead extends SHDLPredefinedOccurence {

	private int nbitAddr;
	private int nbitData;

	public SHDLPredefinedRamsAsynRead(SHDLModuleOccurence moduleOccurence, Pattern namePattern) {
	...
	public String getVHDLDefinition() {
		...
		sb.append(SHDLModule.newline);
		sb.append("-- single-port RAM with asynchronous read" + SHDLModule.newline);
		sb.append(SHDLModule.newline);
