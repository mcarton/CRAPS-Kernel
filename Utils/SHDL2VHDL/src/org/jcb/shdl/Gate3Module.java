...
public abstract class Gate3Module extends Module {
	...
	public Gate3Module(int id, NumExpr nb, boolean inverting) {
		super(id, nb);
	...
	public boolean isPinInverted(int pinId) {
		if ((pinId == 3) && inverting) return true;
		return false;
	}
	...
	public void setShape(int shapeIndex) {
		...
		pinE3 = transform.transform(pinE3_0, null);
