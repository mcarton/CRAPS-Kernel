...
public class CrapsSynthInccc extends CrapsInstrDirecSynth {

	private String dest_reg;

	public CrapsSynthInccc(String dest_reg) {
		this.dest_reg = dest_reg;
	}

	public String toString() {
		return ("SYNTH_INCCC: dest_reg=" + dest_reg);
	}

	public String format() {
		return ("inccc " + dest_reg);
	}
	...
	private long getWord1(ObjModule localSymbols, ObjModule globalSymbols) {
		...
		cacheWord1 += 16 * 524288; //2^19, codeop = 010000
