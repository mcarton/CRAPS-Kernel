...
public class CrapsSynthDec extends CrapsInstrDirecSynth {

	private String dest_reg;

	public CrapsSynthDec(String dest_reg) {
		this.dest_reg = dest_reg;
	}

	public String toString() {
		return ("SYNTH_DEC: dest_reg=" + dest_reg);
	}
	...
	private long getWord1(ObjModule localSymbols, ObjModule globalSymbols) {
		...
		cacheWord1 += 4 * 524288; //2^19, codeop = 000100
