...
public class CrapsSynthNotcc extends CrapsInstrDirecSynth {

	private String src_reg;
	private String dest_reg;

	public CrapsSynthNotcc(String src_reg, String dest_reg) {
		this.src_reg = src_reg;
		this.dest_reg = dest_reg;
	}

	public String toString() {
		return ("SYNTH_NOTCC: src_reg=" + src_reg + ", dest_reg=" + dest_reg);
	}

	public String format() {
		return ("notcc " + src_reg + ", " + dest_reg);
	}
	...
	private long getWord1(ObjModule localSymbols, ObjModule globalSymbols) {
		...
		int nrs2 = Integer.parseInt(dest_reg.substring(2));
		cacheWord1 = nrs1;
		cacheWord1 += 23 * 524288; // 2^19, codeop=010111
		cacheWord1 += nrs2 * 33554432; //2^25;
