  ...
  \chapter{Project management}
    ...
    \section{Project supervision}
      ...
      \section{Risks management}
        ...
        The first risk was put in evidence by Mr Buisson, who told us that some
        specific misuse of the card could lead to permanent damage. So we tried
        to obtain more board, and had 6 boards (none was damaged).

        The second risk was a big concern during a big part of the project, as it
        was difficult to integrate the RAM. We worked on reducing the size of our code,
        but at the end of the project, it was even possible to map the RAM chip on a portion
        of the "virtual" memory (but it was considerably slower).

        The third risk was not solved, however if we communicate slowly from the computer, everything
        works fine, and we don't think the impact of that problem is very important.
