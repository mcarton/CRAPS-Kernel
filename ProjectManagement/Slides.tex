...
\begin{document}
  ...
  \section{Implementation}
    ...
    \begin{frame}{Scheduler}
      ...
      \begin{center}\includegraphics[scale=0.2]{fig/rr.png}\end{center}
    ...
    \begin{frame}{Memory Management}
        ...
        We need to be able to dynamically allocate memory.
        
        In modern computers: virtual memory (segmentation and pagination).
        Too complicated.

        We just need three functions: malloc, free, realloc.
        
        How to free all the memory of a process ?
    \end{frame}
    
    \begin{frame}{Memory Management}
      \begin{itemize}
        \item Stored in blocks, with a header indicating the size and the PID of the owner.
        \item All block have a size that is a power of two.
        \item We never split/merge/delete blocks, we just reuse them if freed.
        \item We can free all the blocks of a process.
      \end{itemize}
    \end{frame}
