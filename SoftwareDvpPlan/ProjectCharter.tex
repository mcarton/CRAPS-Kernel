...
\begin{document}
  ...
  \section{Project Overview}
    ...
    Windows, and we would also like to have them work on GNU/Linux systems.
  ...
  \section{Management of Risks}
    ...
    \risk{3 \times 3 = 9}{
      ...
      This likely to happen and very problematic but we have two FPGAs and the
      possibility to have more in case of problem.
    }{
  ...
  \section{Quality and Configuration Management}
    ...
    from different preexisting projects with no common coding rules, so it is
